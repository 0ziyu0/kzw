...
<div  id="pagin-btm" class="pagin fr" clstag="search|keycount|search|pre-page2">
	...
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2">2</a>
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=3">3</a>
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=4">4</a>
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=5">5</a>
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=6">6</a>
	<span class="text">…</span>
	<a href="products?keyword=java&enc=utf-8&qr=&qrst=UNEXPAND&rt=1&page=2" class="next">下一页<b></b></a>
...
<li class="item-book" bookid="11078102">
	<div class="p-img">
		<a target="_blank" href="/item/base/${item.item.id }.html?storeName=${item.store_name }">
			<img width="160" height="160" data-img="1" data-lazyload="${item.item.image}" />
		</a>
	</div>
	...
	<div class="p-price" style="text-align: center;">
		<i>价格：</i>
		<strong style="margin-left: 37%;">￥<fmt:formatNumber groupingUsed="false" maxFractionDigits="2" minFractionDigits="2" value="${item.item.price / 100 }"/></strong>
	</div>
...
SEARCH.query = "${query}";
SEARCH.bottom_page_html_products(${page},${totalPages},false,${parentId});
   $(function(){
