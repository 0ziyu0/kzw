...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
   ...
   <title>我的购物车 - 开张网商城</title>
   <script>
   	var pageConfig  = {};
   	window.onload = function() { 
   		if(${cartList}.length == 0) {
   				document.getElementById("toSettlement").setAttribute("class", "hide"); ;
   			}
   		}; 
   </script>
<body> 
...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/taotao-logo.gif" title="返回开张网商城首页" alt="返回开张网商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        <div class="column t-checkbox form"><input id="boxid" onclick="selAll();" data-cart="toggle-cb" name="toggle-checkboxes" id="toggle-checkboxes_up" type="checkbox" checked="" value="">
        <label for="toggle-checkboxes_up">全选</label></div>
        <div class="column t-goods">商品</div>
        <div class="column t-price">开张网价格</div>
	        ...
	        <div id="product_11345721" data-bind="rowid:1" class="item item_selected ">
		        <div class="item_form clearfix">
		            ...
		            <div class="cell p-goods">
		                <div class="p-img">
		                	<a href="/item/base/${cart.id }.html" target="_blank">
		                		<img clstag="clickcart|keycount|xincart|p-imglistcart" src="${cart.image}" alt="${cart.title}" width="52" height="52">
		                	</a>
		                </div>    
		                <div class="p-name">
		                	<a href="/item/base/${cart.id }.html" clstag="clickcart|keycount|xincart|productnamelink" target="_blank">${cart.title}</a>
              ...
              <div class="cart-button">
                  ...
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去开张网国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去开张网结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
...
<script type="text/javascript">
	function selAll() {
		// 获取操作复选框
		 var loves = document.getElementsByName("checkItem");
		 // 遍历数组，得到每个复选框
