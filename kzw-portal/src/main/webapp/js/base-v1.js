...
function login() {
    return location.href = "http://localhost:8083/sso/page/login";
}
function regist() {
    return location.href = "http://localhost:8083/sso/page/register";
}
function percenter(){
	alert("sdf");
	return window.location.href = "/personalCenter/index.action";
}
...
window.pageConfig = window.pageConfig || {}, pageConfig.wideVersion = function() {
	...
	// 修改过后放开
	var href = "http://localhost:8080/item/base/";
