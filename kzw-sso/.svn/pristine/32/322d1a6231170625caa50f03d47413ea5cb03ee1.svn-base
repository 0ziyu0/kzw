...
<div class="w">
    <div id="logo">
    	<a href="http://127.0.0.1:8080" clstag="passport|keycount|login|01">
    		<img src="/sso/images/kzw-logo.gif" alt="开张网" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
<form id="formlogin" method="post" onsubmit="return false;">
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            <div id="entry-bg" clstag="passport|keycount|login|02" style="width: 511px; height: 455px; position: absolute; left: -44px; top: -44px; background: url(/sso/images/login.jpg) 0px 0px no-repeat;">
			</div>
            <div class="form ">
			...
			doLogin:function() {
				$.post("/sso/user/login", $("#formlogin").serialize(),function(data){
					if (data.status == 200) {
						alert("登录成功！");
						if (redirectUrl == "") {
							location.href = "http://localhost:8080?token=" + data.data;
						} else {
