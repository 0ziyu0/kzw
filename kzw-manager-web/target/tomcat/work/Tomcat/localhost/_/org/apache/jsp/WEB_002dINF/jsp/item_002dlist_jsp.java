 ...
 * Generated at: 2017-07-13 14:29:38 UTC
...
public final class item_002dlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<span>&nbsp;商品编码:</span>\r\n");
      out.write("\t<input type=\"text\" id=\"barcode\" style=\"border:1px solid #95B8E7;\"/>\r\n");
      out.write("\t<span>&nbsp;商品状态:</span>\r\n");
      out.write("\t<select name=\"status\" class=\"easyui-combobox\" style=\"width:100px;\">\r\n");
      ...
      out.write("</div>\r\n");
      out.write("<table class=\"easyui-datagrid\" id=\"itemList\" title=\"店铺商品列表\" \r\n");
      out.write("       data-options=\"singleSelect:false,collapsible:true,pagination:true,url:'/item/list',method:'post',pageSize:30,toolbar:toolbar\">\r\n");
      out.write("    <thead>\r\n");
      out.write("        <tr>\r\n");
      ...
      out.write("            <th data-options=\"field:'buyPrice',width:70,align:'right',formatter:TAOTAO.formatPrice\">商品进价</th>\r\n");
      out.write("            <th data-options=\"field:'num',width:70,align:'right'\">库存数量</th>\r\n");
      out.write("            <th data-options=\"field:'barcode',width:100\">商品编码</th>\r\n");
      out.write("            <th data-options=\"field:'status',width:60,align:'center',formatter:TAOTAO.formatItemStatus\">状态</th>\r\n");
      out.write("            <th data-options=\"field:'createtime',width:130,align:'center',formatter:TAOTAO.formatDateTime\">创建日期</th>\r\n");
      ...
      out.write("        \t\t\tprice = (price/1000).toFixed(2);\r\n");
      out.write("        \t\t\tdata.price = price;\r\n");
      out.write("        \t\t\tdata.priceView = price;\r\n");
      out.write("        \t\t\tvar buyPice = data.buyPrice;\r\n");
      out.write("        \t\t\tbuyPice = (buyPice/1000).toFixed(2);\r\n");
      out.write("        \t\t\t\r\n");
      out.write("        \t\t\tdata.buyPriceView = buyPice;\r\n");
      out.write("        \t\t\t$(\"#itemeEditForm\").form(\"load\",data);\r\n");
      out.write("        \t\t\t// 加载商品de 描述\r\n");
      out.write("        \t\t\t$.get('/item/desc/'+data.id, function(data){\r\n");
      out.write("            \t\t\tif(data.status == 200){\r\n");
      out.write("            \t\t\t\titemEditEditor.html(data.data.itemDesc);\r\n");
      out.write("            \t\t\t}\r\n");
      out.write("            \t\t});\r\n");
      out.write("        \t\t\t//加载商品的规格\r\n");
      out.write("        \t\t\t$.get('/item/param/'+data.id, function(_data){\r\n");
      ...
      out.write("\t\tvar barcode = $(\"#barcode\").val();\r\n");
