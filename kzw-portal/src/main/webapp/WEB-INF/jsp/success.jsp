...
<div class="w" id="headers">
		<div id="logo"><a href="/"><img alt="开张网商城" src="/images/taotao-logo.gif"></a></div>
		...
		<div class="mc" id="success_detail">	
		    <ul class="list-order">
			    <li class="li-st">
					...
					<!-- 货到付款 -->
					<div class="fore2">货到付款：<strong class="ftx-01">${payment/100}元</strong></div>
					<div class="fore3">
					   	开张网快递 &nbsp; 送货时间: 预计 ${date} 送达&nbsp;
					</div>
				</li>
			</ul>
		<!-- 在线支付按钮  -->
